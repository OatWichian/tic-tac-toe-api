...
import KnexMigrations from './database/knex-connect';
...
async function bootstrap() {
  ...
  KnexMigrations(configService.get('database'));
  ...
  // Swagger Document
  const config = new DocumentBuilder().setTitle(name).setDescription('The API description').setVersion(version).build();
